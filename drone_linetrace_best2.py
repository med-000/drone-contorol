...
time.sleep(2)
sent = sock.sendto('setfps high'.encode(encoding="utf-8"), TELLO_ADDRESS)
    ...
    while True:
        ...
        if num_labels >= 1:
            ...
            if flag == 1:
                ...
                # 旋回方向の不感帯を設定し、旋回量を1.2倍にして機敏にする
                d = 0.0 if abs(dx) < 30.0 else dx * 1.2
                d = -d
